...
class Worker():
    ...
    def _run_training_episode(self,
        ...
        state = env.get_around_state(FLAGS.window_size / 2, state_type='map_all_goals')
        ...
        for _ in range(FLAGS.max_episode_steps):
            ...
            new_state = state[1:] + [env.get_around_state(FLAGS.window_size/2, state_type='map_all_goals')]
